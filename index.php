...
.small-hover:hover { color: #fff !important; }
    ...
    .offcanvas.offcanvas-end { none }
    .offcanvas.show { none }
    .offcanvas-backdrop { none }
    .offcanvas-backdrop.show { none }
  ...
  <div class="position-relative d-flex align-items-center min-vh-100 px-4 px-lg-5 hero-content">
    <div class="ms-5 ms-sm-6 ms-lg-7" style="max-width: 36rem;">
      ...
      <div class="text-start">
        ...
        <div class="d-flex mt-4" style="width:300px;">
          ...
          <div class="flex-fill d-flex flex-column align-items-center">
            ...
            <span class="small fw-semibold text-white text-nowrap mt-2">Certified</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row g-1 g-lg-2">
        <div data-aos="fade-up" class="col-12 col-md-6 col-lg-4">
          <div class="p-2 p-sm-3 transition-all duration-300 bg-white" style="border-radius:0.75rem;cursor:default;" onmouseover="this.style.boxShadow='0 10px 15px -3px rgba(0,0,0,0.1)';this.style.transform='translateY(-6px)'" onmouseout="this.style.boxShadow='none';this.style.transform='none'">
            ...
            <h3 class="fs-6 fw-bold text-dark mb-1">Civil CAD Training</h3>
        ...
        <div data-aos="fade-up" class="col-12 col-md-6 col-lg-4">
          <div class="p-2 p-sm-3 transition-all duration-300 bg-white" style="border-radius:0.75rem;cursor:default;" onmouseover="this.style.boxShadow='0 10px 15px -3px rgba(0,0,0,0.1)';this.style.transform='translateY(-6px)'" onmouseout="this.style.boxShadow='none';this.style.transform='none'">
            ...
            <h3 class="fs-6 fw-bold text-dark mb-1">Architectural Design Services</h3>
        ...
        <div data-aos="fade-up" class="col-12 col-md-6 col-lg-4">
          <div class="p-2 p-sm-3 transition-all duration-300 bg-white" style="border-radius:0.75rem;cursor:default;" onmouseover="this.style.boxShadow='0 10px 15px -3px rgba(0,0,0,0.1)';this.style.transform='translateY(-6px)'" onmouseout="this.style.boxShadow='none';this.style.transform='none'">
            ...
            <h3 class="fs-6 fw-bold text-dark mb-1">Engineering Excellence</h3>
    ...
    <div class="row gx-5 gy-5">
      ...
      <div class="col-lg-6 position-relative">
        ...
        <div class="card text-bg-dark ms-auto" style="max-width:100%; height: 70%; border-radius:0; margin-top: 10rem; border: none; border-color: transparent;">
          <img src="https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=800&q=80" class="card-img" alt="Engineering and design workspace" style="height: 100%; object-fit: cover; border-radius: 0; border: none; border-color: transparent;" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="padding:4rem 0 2.5rem;">
    <div class="container" style="max-width:80rem;">
      <div class="row g-5">
        <div class="col-lg-4">
          ...
          <div class="d-flex gap-2 mt-3">
            <a href="#" class="social-icon border rounded" style="border-color:#334155!important;color:#94a3b8;"><i class="bi bi-linkedin"></i></a>
            <a href="#" class="social-icon border rounded" style="border-color:#334155!important;color:#94a3b8;"><i class="bi bi-youtube"></i></a>
            <a href="#" class="social-icon border rounded" style="border-color:#334155!important;color:#94a3b8;"><i class="bi bi-instagram"></i></a>
            <a href="#" class="social-icon border rounded" style="border-color:#334155!important;color:#94a3b8;"><i class="bi bi-facebook"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3">
          <h6 class="footer-heading text-white">Contact</h6>
      ...
      <div class="footer-bottom d-flex flex-column flex-md-row justify-content-between align-items-center gap-2" style="border-color:#1e293b;">
        <p class="small mb-0">&copy; 2026 CADDFE Training Services. All rights reserved.</p>
